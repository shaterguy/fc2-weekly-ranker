...
- Source version: `0.1.0-dev24`, `versionCode=24`. The crawler preserves the live board-card, published-time, recommendation-count, bounded-concurrency, and next-page-prefetch behavior from dev23 while detail media now also cancels pending probe registrations from the previous detail entry before a new refresh begins.
